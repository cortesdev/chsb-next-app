...
const Seo: FC = () => {
  ...
  return (
    <Head>
      ...
      <meta name="twitter:description" content="CHSB Dashboard App - Lorem ipsum dolor sit ametsed do eiusmod tempor incididunt ut labore et dolore magna aliqua. @swissborg"></meta>
